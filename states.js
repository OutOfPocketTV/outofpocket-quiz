...
// [code, name, population, whiteShare, blackShare, asianShare, obesityRate, incomeMultiplier, ageKey, familyKey]
// Population: Census Bureau state population estimates, rounded.
// Race shares: Census white-alone-non-Hispanic / Black-alone / Asian-
// alone shares, rounded (same categories as the national figures in
// stats.js -- other groups, including Hispanic/Latino of any race and
// multiracial residents, aren't covered by this tool's filter options).
...
const STATE_TABLE = [
  ["AL", "Alabama", 5100000, 0.63, 0.26, 0.015, 0.39, 0.80, "MODERATE", "HIGH"],
  ["AK", "Alaska", 730000, 0.60, 0.03, 0.06, 0.34, 1.05, "YOUNG", "MODERATE"],
  ["AZ", "Arizona", 7400000, 0.53, 0.045, 0.035, 0.31, 0.92, "MODERATE", "MODERATE"],
  ["AR", "Arkansas", 3000000, 0.70, 0.15, 0.015, 0.40, 0.78, "MODERATE", "HIGH"],
  ["CA", "California", 39000000, 0.35, 0.055, 0.15, 0.27, 1.15, "MODERATE", "LOW"],
  ["CO", "Colorado", 5900000, 0.67, 0.04, 0.03, 0.24, 1.10, "MODERATE", "MODERATE"],
  ["CT", "Connecticut", 3600000, 0.65, 0.11, 0.05, 0.28, 1.20, "OLD", "MODERATE"],
  ["DE", "Delaware", 1000000, 0.60, 0.22, 0.04, 0.34, 1.02, "OLD", "MODERATE"],
  ["DC", "District of Columbia", 680000, 0.37, 0.44, 0.045, 0.24, 1.35, "YOUNG", "LOW"],
  ["FL", "Florida", 22600000, 0.51, 0.15, 0.03, 0.28, 0.95, "OLD", "MODERATE"],
  ["GA", "Georgia", 11000000, 0.50, 0.31, 0.045, 0.34, 0.92, "MODERATE", "MODERATE"],
  ["HI", "Hawaii", 1400000, 0.22, 0.02, 0.36, 0.24, 1.05, "OLD", "MODERATE"],
  ["ID", "Idaho", 2000000, 0.78, 0.01, 0.015, 0.30, 0.85, "YOUNG", "HIGH"],
  ["IL", "Illinois", 12500000, 0.58, 0.14, 0.056, 0.32, 1.00, "MODERATE", "MODERATE"],
  ["IN", "Indiana", 6800000, 0.77, 0.095, 0.025, 0.36, 0.85, "MODERATE", "MODERATE"],
  ["IA", "Iowa", 3200000, 0.83, 0.04, 0.025, 0.36, 0.88, "OLD", "HIGH"],
  ["KS", "Kansas", 3000000, 0.74, 0.06, 0.03, 0.35, 0.88, "MODERATE", "MODERATE"],
  ["KY", "Kentucky", 4500000, 0.83, 0.085, 0.015, 0.39, 0.78, "OLD", "HIGH"],
  ["LA", "Louisiana", 4600000, 0.56, 0.31, 0.02, 0.38, 0.80, "MODERATE", "HIGH"],
  ["ME", "Maine", 1400000, 0.89, 0.02, 0.012, 0.32, 0.85, "OLD", "MODERATE"],
  ["MD", "Maryland", 6200000, 0.47, 0.29, 0.065, 0.31, 1.20, "MODERATE", "MODERATE"],
  ["MA", "Massachusetts", 7000000, 0.68, 0.07, 0.07, 0.25, 1.25, "OLD", "LOW"],
  ["MI", "Michigan", 10000000, 0.72, 0.13, 0.03, 0.36, 0.88, "OLD", "MODERATE"],
  ["MN", "Minnesota", 5700000, 0.75, 0.075, 0.055, 0.31, 1.05, "MODERATE", "MODERATE"],
  ["MS", "Mississippi", 3000000, 0.55, 0.37, 0.01, 0.40, 0.72, "MODERATE", "HIGH"],
  ["MO", "Missouri", 6200000, 0.75, 0.11, 0.02, 0.36, 0.85, "MODERATE", "MODERATE"],
  ["MT", "Montana", 1100000, 0.83, 0.006, 0.008, 0.28, 0.85, "OLD", "MODERATE"],
  ["NE", "Nebraska", 2000000, 0.79, 0.045, 0.025, 0.35, 0.90, "MODERATE", "HIGH"],
  ["NV", "Nevada", 3200000, 0.45, 0.09, 0.08, 0.30, 0.95, "MODERATE", "LOW"],
  ["NH", "New Hampshire", 1400000, 0.87, 0.015, 0.03, 0.29, 1.10, "OLD", "MODERATE"],
  ["NJ", "New Jersey", 9300000, 0.50, 0.13, 0.10, 0.28, 1.20, "MODERATE", "MODERATE"],
  ["NM", "New Mexico", 2100000, 0.36, 0.02, 0.015, 0.33, 0.82, "MODERATE", "MODERATE"],
  ["NY", "New York", 19600000, 0.51, 0.14, 0.09, 0.28, 1.15, "MODERATE", "LOW"],
  ["NC", "North Carolina", 10800000, 0.59, 0.20, 0.03, 0.34, 0.90, "MODERATE", "MODERATE"],
  ["ND", "North Dakota", 780000, 0.80, 0.03, 0.015, 0.34, 0.95, "YOUNG", "MODERATE"],
  ["OH", "Ohio", 11800000, 0.76, 0.13, 0.025, 0.36, 0.85, "OLD", "MODERATE"],
  ["OK", "Oklahoma", 4000000, 0.62, 0.075, 0.02, 0.38, 0.80, "MODERATE", "HIGH"],
  ["OR", "Oregon", 4200000, 0.72, 0.02, 0.045, 0.29, 0.98, "MODERATE", "LOW"],
  ["PA", "Pennsylvania", 13000000, 0.73, 0.11, 0.036, 0.34, 0.92, "OLD", "MODERATE"],
  ["RI", "Rhode Island", 1100000, 0.68, 0.06, 0.035, 0.29, 1.00, "OLD", "MODERATE"],
  ["SC", "South Carolina", 5400000, 0.62, 0.25, 0.017, 0.36, 0.82, "OLD", "MODERATE"],
  ["SD", "South Dakota", 920000, 0.80, 0.02, 0.014, 0.34, 0.90, "YOUNG", "HIGH"],
  ["TN", "Tennessee", 7100000, 0.68, 0.16, 0.019, 0.38, 0.83, "MODERATE", "HIGH"],
  ["TX", "Texas", 30500000, 0.39, 0.115, 0.055, 0.35, 0.95, "YOUNG", "MODERATE"],
  ["UT", "Utah", 3400000, 0.74, 0.015, 0.025, 0.31, 0.95, "YOUNG", "HIGH"],
  ["VT", "Vermont", 650000, 0.89, 0.014, 0.017, 0.28, 0.95, "OLD", "LOW"],
  ["VA", "Virginia", 8700000, 0.58, 0.18, 0.07, 0.32, 1.08, "MODERATE", "MODERATE"],
  ["WA", "Washington", 7800000, 0.63, 0.03, 0.095, 0.29, 1.10, "MODERATE", "MODERATE"],
  ["WV", "West Virginia", 1800000, 0.89, 0.035, 0.008, 0.41, 0.72, "OLD", "HIGH"],
  ["WI", "Wisconsin", 5900000, 0.78, 0.06, 0.03, 0.35, 0.90, "MODERATE", "MODERATE"],
  ["WY", "Wyoming", 580000, 0.81, 0.008, 0.009, 0.31, 0.90, "MODERATE", "HIGH"],
];

const STATES = {};
STATE_TABLE.forEach(([code, name, population, white, black, asian, obesity, incomeMult, ageKey, familyKey]) => {
