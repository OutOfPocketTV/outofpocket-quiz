...
const COUNTRIES = {
  ...
  IT: {
    ...
    stats: {
      ...
      notGamblesShare: { men: 0.563, women: 0.702 },
    },
    sourceNote: "Italy-specific estimate from ISTAT, WHO, and World Bank data. Gambling: 43.7% men / 29.8% women past-year (Istituto Superiore di Sanita, national epidemiological study 2017-18, Rapporti ISTISAN 19/28).",
  },
  ES: {
    ...
    stats: {
      ...
      marriedShare: { men: 0.44, women: 0.43 },
      hasKidsShare: { men: 0.46, women: 0.50 },
      notGamblesShare: { men: 0.161, women: 0.161 },
    },
    sourceNote: "Spain-specific estimate from INE Spain, WHO, and World Bank data. Gambling: 83.9% combined-sex past-year participation (CeJuego, Spain's gambling-industry trade association, \"Juego y Sociedad\" survey 2022/23) -- applied to both sexes since no sex-split was found; the high rate is consistent with near-universal participation in Spain's Christmas lottery (El Gordo). Industry-funded source, flagged as a caveat.",
  },
  PT: {
  ...
  PL: {
    ...
    stats: {
      ...
      notGamblesShare: { men: 0.629, women: 0.629 },
    },
    sourceNote: "Poland-specific estimate from GUS Poland, WHO, and World Bank data. Gambling: 37.1% combined-sex past-year participation in offline gambling (lottery, betting, casino, etc.) -- explicitly excludes online-only gambling, which the same study measured separately at a much smaller 4.1% (Lelonek-Kuleta et al. 2020, International Journal of Environmental Research and Public Health 17(2):404, GfK Polonia survey, n=2,000, Dec 2018). Applied to both sexes since no sex-split was found.",
  },
  RU: {
  ...
  UA: {
    ...
    stats: {
      ...
      notGamblesShare: { men: 0.95, women: 0.95 },
    },
    sourceNote: "Ukraine-specific estimate from the State Statistics Service of Ukraine, WHO, and World Bank data; current population figures carry unusual uncertainty. Gambling: only 5% combined-sex past-year participation (Ukraine's first National Gambling Impact Survey, Ministry of Digital Transformation with the Centre for Responsible Gaming, n=3,164, 2024) -- notably lower than other European countries in this dataset, plausibly reflecting wartime economic conditions; applied to both sexes since no sex-split was found.",
  },
  RO: {
    ...
    stats: {
      ...
      hasKidsShare: { men: 0.50, women: 0.55 },
      notGamblesShare: { men: 0.85, women: 0.85 },
    },
    sourceNote: "Romania-specific estimate from INS Romania, WHO, and World Bank data. Gambling: 15% combined-sex past-year participation, 2016 (GfK Romania, n=988, commissioned by the ROMSLOT/Romanian Bookmakers industry associations -- flagged as industry-funded, though conducted by an independent research firm with disclosed methodology). Applied to both sexes since no sex-split was found.",
  },
  CZ: {
    ...
    stats: {
      ...
      marriedShare: { men: 0.47, women: 0.45 },
      hasKidsShare: { men: 0.48, women: 0.53 },
      notGamblesShare: { men: 0.539, women: 0.724 },
    },
    sourceNote: "Czechia-specific estimate from CZSO, WHO, and World Bank data. Gambling: 46.1% men / 27.6% women past-year, 2014 (Czech National Monitoring Centre for Drugs and Addiction, a Czech government body; cross-validated in Szczyrba et al. 2015, Addiction 110(7):1076-1081) -- somewhat dated but the most recent verified sex-split figure found.",
  },
  AT: {
  ...
  HR: {
    ...
    stats: {
      ...
      notGamblesShare: { men: 0.617, women: 0.617 },
    },
    sourceNote: "Croatia-specific estimate from DZS Croatia's 2021 census, WHO obesity data, and World Bank GNI per capita. Obesity, income, and marriage rate (49.3% of population 15+ 'in a marriage', DZS 2021) are population-wide figures applied to both sexes rather than a true split. DZS doesn't collect race/ethnicity. Parenthood rate falls back to the regional average. Gambling: 38.3% combined-sex past-year participation (HZJZ/Croatian Institute of Public Health, national substance-use survey, n=4,756, ages 15-64) -- applied to both sexes since no sex-split was found.",
  },
  BA: {
